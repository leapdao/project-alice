...
const HelpTabPanel = () => (
  <div className="help-tab-panel">
    ...
    <p>
      Here you have three users (Alice, Charlie and Bob) and you can send any
      transaction from one user to another! If you need tx hash and all tx
      history - it's also available.
    </p>
